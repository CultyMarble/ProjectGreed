...
public class DisplayPlayerHeart : MonoBehaviour
{
    ...
    //===========================================================================
    private void UpdateMaxHeartUI(object sender, PlayerHeartManager.OnMaxHealthChangedEventArgs e)
    {
    ...
    private void UpdateCurrentHeartUI(object sender, PlayerHeartManager.OnHealthChangedEventArgs e)
    {
